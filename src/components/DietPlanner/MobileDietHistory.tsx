...
interface MobileDietHistoryProps {
...
const MobileDietHistory: React.FC<MobileDietHistoryProps> = ({
    ...
    const fetchHistory = async () => {
        ...
        try {
            ...
            // Process ALL data - show all entries
                                                    ...
                                                    <div className="flex-1">
                                                            ...
                                                            <div className="flex items-start gap-2 mb-2.5">
                                                                ...
                                                                <div className="flex-1 min-w-0">
                                                                    <h3 className="text-sm font-medium text-gray-900 leading-tight line-clamp-2">
                                                                        {primaryDisplayField.value.charAt(0).toUpperCase() + primaryDisplayField.value.slice(1)}{" "}
                                                                        Diet
                                                                    </h3>
                                                        ...
                                                        {!primaryDisplayField && (
                                                            <div className="flex items-center gap-2 mb-2.5">
                                                                ...
                                                                <span className="text-sm font-medium text-gray-900">{dietType}</span>
                                                            </div>
                                                        )}
                                                                ...
                                                                <div className="flex items-center gap-2 mb-2">
                                                                    ...
                                                                    <div className="flex-1 min-w-0">
                                                                        ...
                                                                        <div className="text-xs text-gray-500 truncate">
                                                                            {itemPrimaryDisplayValue?.value || 'Diet Plan'}
                                                                        </div>
                                                                    </div>
...
export default MobileDietHistory;