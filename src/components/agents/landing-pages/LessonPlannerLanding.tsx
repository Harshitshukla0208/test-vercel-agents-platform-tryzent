...
interface LessonPlannerLandingProps {
  agent: Agent
  metadata?: Metadata
  onGetStarted?: () => void
}
...
const LessonPlannerLanding: React.FC<LessonPlannerLandingProps> = ({
  metadata = {
    ...
    benefits: [],
    keywords: "lesson, planning, education, AI",
    category: "education",
    rating: 4.9,
  ...
  const features: Feature[] = [
    {
      ...
      description: "Clear, measurable learning objectives aligned with curriculum standards",
    },
    {
      icon: Award,
      title: "Learning Outcomes",
      description: "Defined outcomes and success criteria for student achievement",
    },
    {
      icon: FileText,
      title: "Materials Required",
      description: "Complete list of resources, supplies, and materials needed for the lesson",
    },
    {
      icon: Users,
      title: "Prerequisite Competencies",
      description: "Essential skills and knowledge students need before starting the lesson",
    },
    {
      icon: Smartphone,
      title: "Step-by-Step Plan",
      description: "Detailed instructional sequence with timing and teaching strategies",
    },
    {
      icon: AlertTriangle,
      title: "Interactive Activities",
      description: "Engaging exercises and group activities to promote active learning",
    },
    {
      icon: DollarSign,
      title: "HOTS Integration",
      description: "Higher Order Thinking Skills activities for critical thinking development",
    },
    {
      icon: Shield,
      title: "Assessment Tools",
      description: "Quizzes, assignments, and evaluation methods with web resources",
    },
  ]
  ...
  const steps = [
    {
      ...
      description: "Choose subject, grade level, duration, and learning objectives",
    },
    {
      number: "02",
      title: "AI Generation",
      description: "Our AI creates your comprehensive lesson plan",
    },
    {
      number: "03",
      title: "Customize & Teach",
      description: "Review, adjust, and deliver your perfect lesson",
    },
  ]
  ...
  return (
    <div className="min-h-screen bg-white overflow-x-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center">
          <div className="space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-gray-900 leading-tight drop-shadow-sm">
              Educate The Future
              <span className="block text-blue-600 mt-2">With AI Planning</span>
            </h1>

            <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed drop-shadow-sm">
              Create comprehensive lesson plans with detailed activities, learning objectives, assessment rubrics, and
              curriculum alignment.
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center gap-8 text-sm text-gray-600 bg-white/80 backdrop-blur-sm rounded-2xl py-4 px-8 mx-auto max-w-2xl shadow-lg">
              ...
              <div className="font-medium">{metadata.executionCount.toLocaleString()}+ lessons created</div>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Complete Lesson Planning Suite</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Everything you need for effective teaching, powered by AI
            </p>
          </div>
      ...
      >
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">From concept to classroom-ready lesson in three simple steps</p>
          </div>
      ...
      <section className="py-20 bg-blue-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          <div className="space-y-8">
            <h2 className="text-3xl lg:text-4xl font-bold text-white">Ready to Create Amazing Lessons?</h2>
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Join educators who create engaging lessons with comprehensive AI planning
            </p>
            <button
              onClick={onGetStarted}
