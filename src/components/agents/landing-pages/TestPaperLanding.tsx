...
interface TestPaperGeneratorLandingProps {
    agent: Agent
    metadata?: Metadata
    onGetStarted?: () => void
}
...
const TestPaperGeneratorLanding: React.FC<TestPaperGeneratorLandingProps> = ({
    metadata = {
        title: "AI Test Paper Generator",
        description: "Create comprehensive test papers and assessments with AI",
        features: [
            "Custom Questions",
            "Multiple Formats",
            "Difficulty Levels",
        ...
        benefits: [],
        keywords: "test, assessment, AI, education",
        category: "education",
        rating: 4.9,
    ...
    const features: Feature[] = [
        {
            icon: Settings,
            title: "Board & Grade Selection",
            description: "Choose from multiple educational boards, grades, and subjects",
        },
        {
            icon: Clock,
            title: "Duration Control",
            description: "Set custom test duration from 60 minutes to full exam periods",
        },
        {
            icon: Target,
            title: "Difficulty Levels",
            description: "Adjust question difficulty from easy to medium to challenging",
        },
        {
            icon: FileText,
            title: "Chapter Selection",
            description: "Select specific chapters and topics for targeted assessment",
        },
        {
            icon: CheckCircle,
            title: "Question Distribution",
            description: "Customize MCQs, short answers, long answers, and case studies",
        },
        {
            icon: Award,
            title: "Marks Configuration",
            description: "Set total marks and distribute points across different question types",
        },
        {
            icon: Shield,
            title: "Answer Keys Included",
            description: "Complete answer sheets with detailed solutions and explanations",
        },
        {
            icon: Download,
            title: "Professional Format",
            description: "Print-ready test papers with proper formatting and instructions",
        },
    ]
    ...
    const steps = [
        {
            ...
            description: "Choose subject, grade level, question types, and difficulty",
        },
        {
            number: "02",
            title: "AI Generation",
            description: "Our AI creates comprehensive test papers with answer keys",
        },
        {
            number: "03",
            title: "Review & Use",
            description: "Review, customize, and deploy your professional test papers",
        },
    ]
    ...
    return (
        <div className="min-h-screen bg-white overflow-x-hidden">
                ...
                <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 text-center">
                    <div className="space-y-8">
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-gray-900 leading-tight drop-shadow-sm">
                            Create Perfect
                            <span className="block text-blue-600 mt-2">Test Papers</span>
                        </h1>

                        <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed drop-shadow-sm">
                            Generate comprehensive test papers with custom questions, answer keys, and marking schemes tailored to
                        ...
                        <div className="flex flex-wrap items-center justify-center gap-8 text-sm text-gray-600 bg-white/80 backdrop-blur-sm rounded-2xl py-4 px-8 mx-auto max-w-2xl shadow-lg">
                            ...
                            <div className="font-medium">{metadata.executionCount.toLocaleString()}+ tests created</div>
                            <div className="font-medium">{metadata.credits} credits per test</div>
                        </div>
                    </div>
                </div>
            ...
            >
                <div className="max-w-6xl mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl lg:text-4xl font-bold text-gray-900 mb-4">Complete Assessment Creation Suite</h2>
                        <p className="text-xl text-gray-600 max-w-2xl mx-auto">
                            Everything educators need to create professional test papers
                        </p>
                    </div>
            ...
            >
                <div className="max-w-6xl mx-auto px-4 sm:px-6">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-xl text-gray-600">From requirements to professional test paper in three simple steps</p>
                    </div>
            ...
            <section className="py-20 bg-blue-600">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
                    <div className="space-y-8">
                        <h2 className="text-3xl lg:text-4xl font-bold text-white">Ready to Create Better Assessments?</h2>
                        <p className="text-xl text-blue-100 max-w-2xl mx-auto">
                            Join educators who create professional test papers with comprehensive AI-powered assessment tools
                        </p>
                        <button
                            onClick={onGetStarted}
...
export default TestPaperGeneratorLanding
