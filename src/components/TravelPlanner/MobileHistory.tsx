...
import { RefreshCcw, Clock, BookOpen, ChevronDown, Plus, MapPin, Calendar, Users, DollarSign } from 'lucide-react';
...
interface MobileTravelHistoryProps {
...
const MobileTravelHistory: React.FC<MobileTravelHistoryProps> = ({
    onHistoryItemClick,
    containerRef,
    refreshTrigger,
    onCreateNew,
        ...
        const updateHeight = () => {
            if (containerRef?.current) {
                ...
                if (containerHeight > 0) {
                    // Add extra padding for bottom cutoff
                    setMaxHeight(`${containerHeight + 330 + 40}px`);
                }
            }
        };
...
export default MobileTravelHistory;