...
interface MobileLessonHistoryProps {
...
const MobileLessonHistory: React.FC<MobileLessonHistoryProps> = ({
    onHistoryItemClick,
    containerRef,
    refreshTrigger,
    onCreateNew,
                ...
                {!isLoading && !error && agent_id && (
                    <div className="space-y-3">
                        {Object.keys(history).length === 0 ? (
                            <div className="text-center py-8">
                                <Clock className="w-12 h-12 text-gray-300 mx-auto mb-3" />
                                <div className="text-gray-500 text-sm">No lesson plans found</div>
                                <div className="text-gray-400 text-xs mt-1">Create your first lesson plan to get started</div>
                            </div>
                        ) : (
...
export default MobileLessonHistory;